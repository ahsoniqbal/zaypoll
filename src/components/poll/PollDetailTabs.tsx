...
export default function PollDetailTabs(props: Props) {
  ...
  return <Tabs value={tab} onValueChange={changeTab} className="mt-5">
    <TabsList variant="line" className="sticky top-16 z-10 w-full justify-start border-b bg-card/95 backdrop-blur sm:static sm:bg-transparent">
      <TabsTrigger value="reasons" className="px-4 py-2 after:bg-foreground">Reasons</TabsTrigger>
      <TabsTrigger value="analytics" className="px-4 py-2 after:bg-foreground">Analytics</TabsTrigger>
    </TabsList>
